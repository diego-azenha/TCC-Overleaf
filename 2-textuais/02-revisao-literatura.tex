...
\begin{figure}[h]
\centering
% PLACEHOLDER: Figura 4.2 de Paleologo — modelo gráfico com fatores, loadings e ativos
\caption{Interpretação generativa do modelo fatorial: fatores propagam-se aos retornos dos ativos por meio das exposições fatoriais \textcite{paleologo2025}.}
...
\begin{figure}[h]
\centering
% PLACEHOLDER: Figura 4.1 de Paleologo — matriz de loadings particionada em blocos de estilo, país e setor
\caption{Estrutura típica da matriz de exposições fatoriais $B$ em modelos de características, particionada em blocos de estilo, país e setor \textcite{paleologo2025}.}
