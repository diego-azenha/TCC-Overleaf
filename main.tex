...
% Título
\titulo{FactorVAE no Mercado Brasileiro de Ações}
% Subtítulo
\subtitulo{: Replicação e Avaliação de um Modelo de Fatores Latentes Probabilístico}
% Autor (nome completo)
...
\professores{PLACEHOLDER: membros da banca}
