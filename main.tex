\documentclass[
    ...
    brazillian % suporte a idioma para hifenização (último idioma declarado é o principal do documento)
]{insper-abntex2}
...
% Título
\titulo{Factor Investing sob a Perspectiva do \break Machine Learning Probabilístico}
% Subtítulo
...
\palavraschaves{Factor Investing, Aprendizado Profundo, Ações}
% Palavras-chaves em inglês (importante: separar por vírgulas)
\keywords{Factor Investing, Deep Learning, Stocks}
% Professores convidados (importante: separar por vírgulas)
\professores{Adam Smith, John Maynard Keynes, Robert Lucas Jr.}

% Preâmbulo
\preambulo{Trabalho de Conclusão de Curso apresentado ao Curso de Graduação em Economia como requisito parcial para a obtenção do título de Bacharel em Economia.}
...
\include{2-textuais/02-revisao-literatura}
